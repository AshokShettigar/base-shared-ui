    ...
    render() {
        return (
            <div>
                ...
                {this.props.shouldShow(`${this.props.name}.${SELECTED_FIELD}`, 'hourly') &&
                    <Hourly {...this.props} name={`${this.props.name}.hourly`} />
                }
                {this.props.shouldShow(`${this.props.name}.${SELECTED_FIELD}`, 'daily') &&
                    <Daily {...this.props} name={`${this.props.name}.daily`} />
                }
                {this.props.shouldShow(`${this.props.name}.${SELECTED_FIELD}`, 'weekly') &&
                    <Weekly {...this.props} name={`${this.props.name}.weekly`} />
                }
                {this.props.shouldShow(`${this.props.name}.${SELECTED_FIELD}`, 'monthly') &&
